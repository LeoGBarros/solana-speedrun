# Message Registry — Solana / Anchor (devnet)
...
- `programs/message_registry/src/` — programa Anchor (modular):
...
- `client/` — cliente Rust isolado que envia as transações de interação contra a devnet
